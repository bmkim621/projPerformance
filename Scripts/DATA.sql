...
('안녕하세요? 대구오페라하우스입니다. 이번 3월 3일자로 저희 대구오페라하우스가 임시 개통을 하였습니다. 부족한 부분들에 대해서는 꾸준히 Update 하겠습니다. 여러분들의 따뜻한 말씀을 기다리겠습니다. 감사합니다.', '대구오페라하우스 홈페이지 임시개통', 0, 'M1901', '관리자'),
('(재)대구오페라하우스 제17회 소극장오페라 및 창작오페라 공모 선정작을 최종 선정팀에게 전화로 알려드렸습니다. 지원자분들의 많은 관심과 성원에 감사드립니다.', '(재)대구오페라하우스 제 17회 소극장오페라 및 창작오페라 공모 선정작 발표 안내', 0, 'M1901', '관리자'),
(null, '2019 Daegu Opera House Oprenstudio Audition', 0, 'M1901', '관리자'),
('캐스팅은 사전 공지 없이 변경될 수 있습니다.', '발레 <호두까기인형> 캐스팅 변경 안내', 0, 'M1901', '관리자'),
(null, '제16회 대구국제오페라축제 얼리버드 티켓오픈 안내', 0, 'M1901', '관리자'),
('2019년도 오페라코치 & 반주자 선발오디션 최종합격자는 전화로 합격여부를 알려드렸습니다. 지원자분들의 많은 관심과 성원에 감사드립니다.', '2019 (재)대구오페라하우스 오페라코치 & 반주자 선발오디션 최종합격자 안내', 0, 'M1901', '관리자'),
(null, '2019 오펀스튜디오 오디션 합격자 공지', 0, 'M1901', '관리자'),
(null, '2018 렉쳐오페라 공연작품 공모사업', 0, 'M1901', '관리자'),
(null, '2018 상반기 정기대관 공고', 0, 'M1901', '관리자'),
('대구국제오페라축제 온라인 자원활동가 3기 오페라팬(Operafan) 합격자를 아래와 같이 발표합니다. 많은 지원과 관심 감사드립니다.', '온라인 자원활동가 오페라팬 3기 합격자 발표', 0, 'M1901', '관리자'),
(null, '2019년 상반기 수시대관 신청 공고', 0, 'M1901', '관리자');
